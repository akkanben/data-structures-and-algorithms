...
const addOne = (arr) => {
  const outputArray = [];
  arr.forEach((element) => outputArray.push(element + 1));
  return outputArray;
};
...
const addExclamation = (arr) => {
  const outputArray = [];
  arr.forEach((element) => outputArray.push(element + '!'));
  return outputArray;
};
...
const allUpperCase = (arr) => {
  const outputArray = [];
  arr.forEach((element) => outputArray.push(element.toUpperCase()));
  return outputArray;
};
...
const speaker = (words, callback) => {
  const outputArray = [];
  words.forEach((element) => outputArray.push(callback(element)));
  return outputArray;
};
...
const addNumbers = (num, arr, times, callback) => {
  ...
  for (let i = 0; i < times; i++) {
    arr.push(callback(outputArray, num));
  }
  return outputArray;
};
...
const fizzbuzz = (arr) => {
  const outputArray = [];
  arr.forEach((element) => {
    if (element % 3 === 0 && element % 5 === 0) outputArray.push('Fizz Buzz');
