...
const alphabetizeBetter = (arr) => {
  return arr.sort((a, b) => a.localeCompare(b)); //Found this option on mdn
};
...
const sortPeopleBetter = (arr) => {
  return arr.sort((a, b) => a.age - b.age).sort((a, b) => a.firstName.localeCompare(b.firstName)).sort((a, b) => a.lastName.localeCompare(b.lastName));
};
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a, b) => weekdayOrder.indexOf(a.dayOfWeek) - weekdayOrder.indexOf(b.dayOfWeek));
};
/* ------------------------------------------------------------------------------------------------
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a, b) => a.end - b.end).sort((a, b) => weekdayOrder.indexOf(a.dayOfWeek) - weekdayOrder.indexOf(b.dayOfWeek));
};
